...
public class TutorialStartActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Thread endThread; //타이머 끝난뒤 실행될 스레드
    Thread waitThread; //8초 대기 스레드
    ...
    Button backButton, hintButton; //맨위 버튼 두개
    Button checkCombination, inputCombination; // 결 합 버튼
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        endIntent=new Intent(TutorialStartActivity.this,TutorialEndActivity.class);
        ...
        checkCombination = (Button) findViewById(R.id.checkCombination);
        inputCombination = (Button) findViewById(R.id.inputCombination);
            ...
            if (isFPturn == false && isSPturn == false || isFPturn == true && isSPturn == true) {//1p 혹은 2p 아이콘이 눌려있어야한다.
                ...
                if (combinationCount == 0) { //주어진 합의 조합이 0 이 되었을떄.
                    ...
                    if(gameRound < 10){
                        ...
                        endIntent=new Intent(this,TutorialEndActivity.class);
                        endIntent.putExtra("FP_score",FP_gamePoint);
                        endIntent.putExtra("SP_score",SP_gamePoint);
